        ...
        <FadeIn>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-white/60">
              Wir kümmern uns um alles, damit du dich auf dein Kerngeschäft
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {solutions.map((item, i) => (
            <FadeIn key={i} delay={i * 0.1} direction="up">
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 h-full group">
                <div className="w-12 h-12 rounded-lg bg-electric/20 flex items-center justify-center mb-5 group-hover:bg-electric/30 transition-colors">
                  {item.icon}
                </div>
